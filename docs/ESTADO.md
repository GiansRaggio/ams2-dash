...
Correccion del mismo dia: la envolvente sola dejaba la trazada pegada al borde (con 4 vueltas el corredor ERA la trazada). Ahora el borde es (1) la evidencia de piano/pasto -- agrupada por metro en cumulos, porque el mismo piano pisado desde los dos lados de la linea de referencia se leia como dos bordes a 1.5 m (Silverstone daba 4 m de ancho) --, (2) el otro lado al ancho mediano de la pista medido donde hay evidencia de ambos lados (>6 m; Mosport 12.2, Road Atlanta 12.3; sin pares, 12 m supuesto), (3) huecos interpolados sobre el borde compuesto hasta 400 m y suavizado de 10 m, (4) la envolvente de asfalto manda si sale mas afuera. La interpolacion de evidencia es CORTA (30 m): los desplazamientos son relativos a la linea de carrera, que cruza la pista en cada curva.
